...
public class GmailTest extends TestBase {
	...
	public void gmailTestLoginSuccess(){
		...
		gmailPage.login(PropertiesCache.getProperty("user.nameValid"), PropertiesCache.getProperty("user.passwordValid"));
	...
	public void gmailTestLoginFailed(){
		GmailPage gmailPage = new GmailPage(driver);
		gmailPage.login(PropertiesCache.getProperty("user.nameValid"), PropertiesCache.getProperty("user.passwordInvalid"));
