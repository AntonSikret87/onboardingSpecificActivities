package net.demandware.astound20.pages.astoundPages;
...
public class PLPPage extends BasePage {
	...
	By productInCartLocator =
			By.xpath(PropertiesCache.getProperty("productInCart.xpath"));
	...
	By paginationSelectPLPtLocator = By.id(PropertiesCache.getProperty("dropDownElement.id"));
	...
	public void changeValueInDropDown(String pageAmountIndexToBeDisplayed) {
		lstSelectPaginationPLP = driver.findElement(paginationSelectPLPtLocator);
